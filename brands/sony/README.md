...
Sony Xperia XZ1 (`poplar`, `poplar_dsds`, `poplar_kddi`), XZ1 Compact (lilac) and XZ2 (Tama), including Japan Units like `au`, `Softbank` and `Docomo` using the Snapdragon 835 and Snapdragon 845 can be unlocked via the [xperable exploit][xperable].
